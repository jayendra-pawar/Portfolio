  ...
  return (
    ...
    >
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        <AnimatedTitle
          text={
            "i MAKE BRANDS BEAUTIFUL, SOFTWARE POWERFUL AND experience GREATFUL."
          }
          className={
        ...
        <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-medium  leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16  lg:max-w-[90%] lg:text-[24px] ">
            ...
            <AnimatedBody
              text={
                "Whether it’s binge-watching my favorite documentary series, cheering on Manchester United, hanging out with friends, or discovering new music in my favorite genres. I’m always looking for ways to relax and unwind."
              }
            />
            <AnimatedBody
              text={
          ...
          <div className="flex flex-col gap-3">
              ...
              <AnimatedBody
                text={
                  "Codeforces, Codechef, Leetcode, HackerRank, MLH"
                }
              />
            </div>
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimatedBody
                text={
                  "C++, Golang, AWS, JavaScript(ES6+), React, Next.js, TypeScript, RabbitMQ, Redis, Java, Redux, Redux Toolkit, React Testing Library, HTML5, SQL, Git/GitHub, NextAuth"
                }
              />
            </div>
            <div className="flex flex-col gap-3">
              ...
              <AnimatedBody
                text={
                  "CSS3/SCSS/SASS, Tailwind CSS, Material UI, Framer Motion, Chart.js."
                }
              />
            </div>
            <div className="flex flex-col gap-3">
              ...
              <AnimatedBody
                text={
                  "Figma, FigJam, Adobe Photoshop, UX Research, UI Design."
                }
              />
            </div>
          </div>
